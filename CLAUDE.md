...
> Status at last full pass: **379 tests passing across 29 files · TypeScript strict · production build ~2.7s.** Live demo at https://jonathanabarnett.github.io/kingdomos/ — auto-deployed on every push to `main` via `.github/workflows/pages.yml`.
...
npm test              # Vitest suite (379 tests across 29 files)
...
│       ├── Quests.ts         # 13 multi-day arcs + 10 decision archetypes — all seeded; ArcDef.guard + pickFlavor hooks for stateful arcs
...
| Quest arcs | 13 (`traveler`, `festival_prep`, `rival_banner`, `scholar_discovery`, `wandering_cat`, `river_flood`, `lost_child`, `old_friend_returns`, `village_well`, `fence_dispute`, `letter_from_afar`, `tournament`, `returning_bloodline`) |
...
379 tests across 29 files. New systems should have at least 4–6 tests covering:
- Happy path
