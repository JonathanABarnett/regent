...
export class Treasury {
  ...
  /** Add an artifact of the given kind. Origin optional. */
  acquire(kind: ArtifactKind, origin?: string): Artifact {
    ...
    const artifact: Artifact = {
      ...
      obtainedOnYear: this.world.state.year,
    };
    ...
    this.journal.write(
      `${KIND_PREFIX[kind]} ${chosen} was placed in the royal vault${origin ? " — " + origin : ""}.`,
      "milestone",
    );
