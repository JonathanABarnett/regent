...
const TRAIT_LINES: Record<NPCTrait, readonly string[]> = {
  joyful: [
    ...
    "{name} declared the weather \"acceptable\" and then made a joke about it. The joke was not good. {name} laughed anyway.",
    "{name} told a story at the well today that the children retold all afternoon, slightly wrong each time, getting funnier as it went.",
  ],
  grim: [
    ...
    "{name} muttered something about \"the old plague years\" while sharpening a knife. No one asked them to expand.",
    "{name}: \"every kingdom ends. Best to keep that in mind when buying lumber.\"",
  ],
  curious: [
    ...
    "{name} spent the afternoon copying out a star chart by the light of a borrowed lamp. They had questions for the scholar by morning.",
    "{name} asked the smith whether iron remembers being ore. The smith stared at them for a long beat.",
  ],
  stoic: [
    ...
    "{name} was asked if they were tired. They considered the question for some time and then said \"yes.\" Nothing else.",
    "{name} fixed the broken fence post without being asked or thanked, and went back to whatever they had been doing before.",
  ],
  kind: [
    ...
    "{name} stayed up past midnight with a neighbour whose child wouldn't settle. Both children were asleep by dawn. So was {name}, briefly.",
    "{name} learned the names of every new arrival this week. They make a point of it. They say it costs nothing.",
  ],
  ambitious: [
    ...
    "{name} requested a meeting with the crown today \"about the future of the realm.\" The meeting has not yet been granted.",
    "{name}: \"in twenty years there will be a road from the gate to the river. You'll see.\" They have been saying this for two years.",
  ],
  anxious: [
    ...
    "{name} packed a small bag this morning \"just in case.\" They did this last week too. They have not yet had to use it.",
    "{name}: \"do you smell smoke? No? Are you sure?\" There was no smoke.",
  ],
  wise: [
    ...
    "{name} corrected the chronicler on a small point of fact, gently, and the chronicler thanked them.",
    "{name}: \"the kingdom is older than any of us, and will outlast all of us. Plan accordingly.\"",
  ],
};
